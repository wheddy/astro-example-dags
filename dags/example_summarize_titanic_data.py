...
default_args={
    "owner": "Bill Eddy,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2023-10-25", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Bill Eddy": "mailto:wheddy67@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clo6746ox007w01i7empauaje/cloud-ide/clo686y9j008f01jh66olh0o5/clo686ygy009v01j3frzin4k2",
    },
)
